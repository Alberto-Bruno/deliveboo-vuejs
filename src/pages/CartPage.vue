                ...
                <form @submit.prevent="sendForm">
                    <div v-if="!showPayment">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" :class="{ 'is-invalid': errors.firstname }" name="nome"
                                id="nome" v-model.trim="form.firstname" placeholder="Inserisci nome" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" :class="{ 'is-invalid': errors.lastname }"
                                name="cognome" id="cognome" v-model.trim="form.lastname" placeholder="Inserisci cognome" />
                            <div class="invalid-feedback">{{ errors.lastname }}</div>
                        </div>

                        <div class="form-group">
                            <label for="indirizzo" class="control-label text-white fw-bold mt-3">Indirizzo</label>
                            <input type="text" class="form-control" :class="{ 'is-invalid': errors.address }"
                                name="indirizzo" id="indirizzo" v-model.trim="form.address"
                        ...
                        <div class="form-group">
                            ...
                            <input type="mail" class="form-control" :class="{ 'is-invalid': errors.email }" name="email"
                                id="email" v-model.trim="form.email" placeholder="Inserisci mail" />
                            <div class="invalid-feedback">{{ errors.email }}</div>
                        </div>

                        <div class="form-group">
                            <label for="delivery_time" class="control-label text-white fw-bold mt-3">Orario di
                                consegna</label>
                            <input type="time" class="form-control" :class="{ 'is-invalid': errors.delivery_time }"
                                name="delivery_time" id="delivery_time" v-model.trim="form.delivery_time" />
                            <div class="invalid-feedback">{{ errors.delivery_time }}</div>
                        </div>

                        <div class="form-group d-flex justify-content-between mt-4">
                            <router-link :to="{ name: 'home' }" class="btn btn-sm bg-danger text-white fw-bold text-white">
                                Indietro
                            </router-link>
                            <button @click="goToPayments" type="button"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="card-body p-3">
                                                        ...
                                                        <p class="fw-semibold mb-0">
                                                            Prezzo: <span>{{ dish.price }} &euro;</span><span>x {{
                                                                dish.quantity }}</span>
                                                        </p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row d-flex justify-content-between">
                                        <div class="col-auto">
                                            <div class="d-flex justify-content-between align-items-center my-3">
                                                <button class="btn btn-sm indietro fw-semibold text-primary"
                                                    :disabled="dish.quantity == 0" @click="deleteQuantity(dish)">
                                                ...
                                                <button class="btn btn-sm indietro fw-semibold text-danger"
