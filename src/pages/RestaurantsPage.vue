            ...
            <div class="card-deck">
                <div v-for="restaurant in restaurants" :key="restaurant.id" class="card mb-3">
                    <div class="row no-gutters">
                        ...
                        <a href="#">
                            <img :src="restaurant.types[0].image" class="card-img" alt="...">
                        </a>
                        </div>
                        <div class="col-md-8">
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        <h5 class="card-title fw-bold">Costo di consegna:<span class="txt-light">{{ restaurant.delivery_cost === '0.00' ? ' Gratis' : '€ ' + restaurant.delivery_cost }}</span> </h5>

                                        <h5 class="card-title fw-bold">Ordine Minimo:<span class="txt-light">  {{  restaurant.min_order ? '€' + restaurant.min_order : ' -' }}</span> </h5>
